...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Alert.user_email'
        db.add_column(u'alert_alert', 'user_email',
                      self.gf('django.db.models.fields.EmailField')(max_length=254, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Alert.user_email'
        db.delete_column(u'alert_alert', 'user_email')
    ...
    models = {
        ...
        u'alert.alert': {
            ...
            'user_email': ('django.db.models.fields.EmailField', [], {'max_length': '254', 'null': 'True', 'blank': 'True'}),
