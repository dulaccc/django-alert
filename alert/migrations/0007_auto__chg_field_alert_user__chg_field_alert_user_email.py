...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Alert.user'
        db.alter_column(u'alert_alert', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

        # Changing field 'Alert.user_email'
        db.alter_column(u'alert_alert', 'user_email', self.gf('django.db.models.fields.EmailField')(default='', max_length=254))

    def backwards(self, orm):

        # Changing field 'Alert.user'
        db.alter_column(u'alert_alert', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['auth.User']))

        # Changing field 'Alert.user_email'
        db.alter_column(u'alert_alert', 'user_email', self.gf('django.db.models.fields.EmailField')(max_length=254, null=True))
    ...
    models = {
        ...
        u'alert.alert': {
            ...
            'title': ('django.db.models.fields.CharField', [], {'default': "u'example.com alert'", 'max_length': '250'}),
